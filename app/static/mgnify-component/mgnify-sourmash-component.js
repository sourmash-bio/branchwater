...
`,lt=nt;var at=function(t,e,i,s){var r,o=arguments.length,n=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(r=t[l])&&(n=(o<3?r(n):o>3?r(e,i,n):r(e,i))||n);return o>3&&n&&Object.defineProperty(e,i,n),n};const ht=new function(){return new Worker(t.p+"mgnify-sourmash-component.worker.js")},dt=[".fa",".fasta",".fna",".gz",".fq",".fastq"];let ct=class extends it{constructor(){super(),this.directory=!1,this.show_directory_checkbox=!1,this.show_signatures=!1,this.num=0,this.ksize=21,this.is_protein=!1,this.dayhoff=!1,this.hp=!1,this.seed=42,this.scaled=1e3,this.track_abundance=!1,this.selectedFiles=null,this.progress={},this.signatures={},this.errors={},ht.addEventListener("message",(t=>{var e;switch(null===(e=null==t?void 0:t.data)||void 0===e?void 0:e.type){case"progress:read":this.progress[t.data.filename]=t.data.progress,this.requestUpdate();break;case"signature:error":this.errors[t.data.filename]=t.data.error,this.dispatchEvent(new CustomEvent("sketchedError",{bubbles:!0,detail:{filename:t.data.filename,error:t.data.error}})),this.requestUpdate();break;case"signature:generated":this.signatures[t.data.filename]=t.data.signature,this.progress[t.data.filename]=100,this.dispatchEvent(new CustomEvent("sketched",{bubbles:!0,detail:{filename:t.data.filename,signature:t.data.signature}})),this.haveCompletedAllSignatures()&&this.dispatchEvent(new CustomEvent("sketchedall",{bubbles:!0,detail:{signatures:this.signatures,errors:this.errors}})),this.requestUpdate()}}))}haveCompletedAllSignatures(){return Object.keys(this.progress).every((t=>t in this.signatures||t in this.errors))}setChecked(t){this.directory=t.target.checked}clear(){this.selectedFiles=null,this.progress={},this.signatures={},this.errors={},this.renderRoot.querySelector("#sourmash-selector").value=null,this.requestUpdate()}renderSelectedFiles(){var t;return((null===(t=this.selectedFiles)||void 0===t?void 0:t.length)||0)<1?"":B`
    ...
    `}handleFileChanges(t){t.preventDefault(),this.selectedFiles=Array.from(t.currentTarget.files).filter((t=>{for(const e of dt)if(t.name.endsWith(e))return!0;return!1})),ht.postMessage({files:this.selectedFiles,options:{num:this.num,ksize:this.ksize,is_protein:this.is_protein,dayhoff:this.dayhoff,hp:this.hp,seed:this.seed,scaled:this.scaled,track_abundance:this.track_abundance}}),this.dispatchEvent(new CustomEvent("change",{bubbles:!0,detail:{selectedFiles:this.selectedFiles}})),this.requestUpdate()}};ct.styles=[lt],at([rt({type:Boolean,reflect:!0})],ct.prototype,"directory",void 0),at([rt({type:Boolean})],ct.prototype,"show_directory_checkbox",void 0),at([rt({type:Boolean})],ct.prototype,"show_signatures",void 0),at([rt({type:Number})],ct.prototype,"num",void 0),at([rt({type:Number})],ct.prototype,"ksize",void 0),at([rt({type:Boolean})],ct.prototype,"is_protein",void 0),at([rt({type:Boolean})],ct.prototype,"dayhoff",void 0),at([rt({type:Boolean})],ct.prototype,"hp",void 0),at([rt({type:Number})],ct.prototype,"seed",void 0),at([rt({type:Number})],ct.prototype,"scaled",void 0),at([rt({type:Boolean})],ct.prototype,"track_abundance",void 0),ct=at([(t=>e=>"function"==typeof e?((t,e)=>(window.customElements.define(t,e),e))(t,e):((t,e)=>{const{kind:i,elements:s}=e;return{kind:i,elements:s,finisher(e){window.customElements.define(t,e)}}})(t,e))("mgnify-sourmash-component")],ct)})();
